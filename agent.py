...
# This needs multiple nodes.py, you do not need to pip install nodes
...
from nodes.red_flag_check import red_flag_check_node # Fraud detection logic
...
def build_agent_graph() -> StateGraph:
    ...
    # ---- Entry Point ----
    # Every sensitive request must pass identity verification first
